    ...
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://github.com/JayantKumarJha"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
      ...
      <div className="absolute left-[50%] top-2 translate-x-[-50%]">
        <motion.a
          href="/"
          className="w-16 h-16 bg-dark text-light flex items-center justify-center rounded-full text-2xl font-bold dark:bg-light dark:text-dark"
      ...
      {isOpen && (
        ...
        >
          <nav className="flex items-center flex-col justify-center">
            <CustomMobileLink href="/" title="Home" toggle={handleMobileMenu} />
            <CustomMobileLink href="/about" title="About" toggle={handleMobileMenu} />
            <CustomMobileLink href="/projects" title="Projects" toggle={handleMobileMenu} />
            <CustomMobileLink href="/articles" title="Articles" toggle={handleMobileMenu} />
          </nav>
