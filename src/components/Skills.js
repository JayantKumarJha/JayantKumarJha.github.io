  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
        ...
        <Skill name="Operations Research" x="-20vw" y="2vw" />
        <Skill name="Machine Learning" x="15vw" y="-12vw" />
        <Skill name="Deep Learning" x="0vw" y="12vw" />
        <Skill name="Reinforcement Learning" x="-20vw" y="-15vw" />
        <Skill name="Optimization Algorithms" x="15vw" y="8vw" />
        <Skill name="Production Scheduling" x="32vw" y="-5vw" />
        <Skill name="Decision Systems" x="0vw" y="-20vw" />
        <Skill name="Industrial AI" x="-25vw" y="18vw" />
        <Skill name="Data Analysis" x="18vw" y="18vw" />
        <Skill name="Algorithm Design" x="-35vw" y="-5vw" />
      </div>
    </>
  )
}
